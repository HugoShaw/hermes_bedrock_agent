"""Pydantic schemas for dual-RAG chunks, entities, and retrieval results."""
...
class Chunk(BaseModel):
    ...
    sheet_index: int  # 1-27, or 0 for cross_sheet_summary
    sheet_name: str
    workbook_name: str
...
class QAAnswerResponse(QAResponse):
    answer: str = ""
    graph_context_text: str = ""  # serialized graph text sent to the LLM
